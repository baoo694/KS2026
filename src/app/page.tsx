...
const features = [
  {
    icon: Zap,
    title: 'Learn Faster',
    description: 'Spaced repetition algorithm ensures you remember more in less time.',
    color: 'from-amber-400 to-orange-500',
  },
  {
    icon: Target,
...
export default function HomePage() {
  return (
    <div className="relative overflow-hidden" style={{ fontFamily: "'Nunito', sans-serif" }}>
      {/* Google Fonts */}
      <style jsx global>{`
              ...
              <div className="relative w-full aspect-square max-w-lg mx-auto">
                ...
                <ClayCard className="absolute top-8 left-8 w-72 h-48 bg-gradient-to-br from-rose-100 to-pink-50 rotate-[-8deg]" hover={false}>
                  <div className="p-6">
                    ...
                    <div className="font-display font-bold text-slate-800">Master Mode</div>
                    <div className="text-sm text-slate-500">98% accuracy</div>
                  </div>
                </ClayCard>
                
                {/* Middle card */}
                <ClayCard className="absolute top-16 left-24 w-72 h-48 bg-gradient-to-br from-amber-100 to-orange-50 rotate-[4deg]" hover={false}>
                  <div className="p-6">
                    <div className="text-4xl mb-2">⚡</div>
                    <div className="font-display font-bold text-slate-800">Speed Round</div>
                    <div className="text-sm text-slate-500">Beat your best time!</div>
                  </div>
                </ClayCard>
                
                {/* Front card */}
                <ClayCard className="absolute top-24 left-16 w-80 h-52 bg-gradient-to-br from-indigo-100 to-blue-50" hover={false}>
                  <div className="p-6 h-full flex flex-col justify-between">
                    <div>
                      <div className="text-4xl mb-2">🧠</div>
                      <div className="font-display text-xl font-bold text-slate-800">What is photosynthesis?</div>
                    </div>
      ...
      <section className="py-20 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {courses.map((course) => (
              <ClayCard key={course.id} className={`${course.cardBg} overflow-hidden`}>
                <div className="p-6">
                  <div className={`inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-gradient-to-br ${course.color} text-2xl mb-4 shadow-lg`}>
                    {course.icon}
                  </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {features.map((feature) => (
              <ClayCard key={feature.title} className="p-6 text-center">
                <div className={`inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br ${feature.color} mb-4 shadow-lg`}>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-2 lg:order-1">
              <ClayCard className="p-8 bg-gradient-to-br from-indigo-50 to-blue-50" hover={false}>
                <h4 className="font-display text-xl font-bold text-slate-900 mb-6">Your Progress This Week</h4>
                
                {/* Progress bars */}
                <div className="space-y-5">
                  {[
                    { subject: 'Biology', progress: 85, color: 'from-emerald-400 to-teal-500' },
                    { subject: 'History', progress: 62, color: 'from-amber-400 to-orange-500' },
                    { subject: 'Spanish', progress: 94, color: 'from-rose-400 to-pink-500' },
                  ].map((item) => (
                ...
                <div className="grid grid-cols-3 gap-4 mt-8 pt-6 border-t-2 border-slate-200">
                  <div className="text-center">
                    <div className="font-display text-2xl font-bold text-indigo-600">156</div>
                    <div className="text-xs text-slate-500">Cards Learned</div>
                  </div>
                  <div className="text-center">
                    <div className="font-display text-2xl font-bold text-emerald-600">12</div>
                    <div className="text-xs text-slate-500">Day Streak</div>
                  </div>
                  <div className="text-center">
                    <div className="font-display text-2xl font-bold text-amber-600">4.2h</div>
            ...
            <div className="order-1 lg:order-2 text-center lg:text-left">
              ...
              <p className="text-xl text-slate-600 mb-8">
                Watch your knowledge grow with beautiful progress tracking. See exactly what you&apos;ve mastered and what needs more practice.
              </p>
      ...
      <section className="py-20 px-4">
        <div className="max-w-4xl mx-auto">
          <ClayCard className="relative overflow-hidden bg-gradient-to-br from-indigo-500 via-violet-500 to-indigo-600 p-12 text-center" hover={false}>
            {/* Decorative elements */}
